...
public interface BugRepository extends JpaRepository<Bug, Integer> {
    ...
    @Query(value = "CALL sp_create_bug(:projectId, :title, :description, :reportedBy, :assignedTo, :severityId, :priorityId, :statusId, :createdBy)", nativeQuery = true)
    void createBug(
    ...
    @Query(value = "CALL sp_get_bugs_by_project(:projectId)", nativeQuery = true)
    List<Bug> getBugsByProject(@Param("projectId") String projectId);
